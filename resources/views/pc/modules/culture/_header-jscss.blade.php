<link rel="alternate" media="only screen and(max-width: 640px)" href="http://m.yac8.com/">
...
<script language="javascript" type="text/javascript">var webTypeName = 'home';
    var webDataID = '0';
    var dbPathPart = '../';
    var webPathPart = '';
    var jsPathPart = '';</script>
<script language="javascript" type="text/javascript" src="{{$commonAssetUrl}}/culture/js/config.js"></script>
