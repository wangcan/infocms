...
<meta name="mobile-agent" content="format=html5;url=https://m.maigoo.com/brand/webshop_2411.html">
...
<link href="<?= Yii::getAlias('@tasseturl'); ?>/sguide/css/7ba7a-2311.css" type="text/css" rel="stylesheet" />
    ...
    <div id="pagenav" class="col0">
        <div class="pagenav bg1">
            <div class="navcont">
                ...
                <a class="fff font20 line2em active cfff webshop" href="https://www.maigoo.com/brand/webshop_2411.html">网店</a>
                                ...
                                <li class="item">
                                    <div class="imgbox">
                                        <a target="_blank" href="https://www.maigoo.com/webshop/317455.html">
                                            <img src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/img/c1f79-6401.jpg" /></a>
                                    </div>
                                    <div class="cont">
                                        <ul>
                                            <li class="webtitle font18">
                                ...
                                <li class="item">
                                    <div class="imgbox">
                                        <a target="_blank" href="https://www.maigoo.com/webshop/317454.html">
                                            <img src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/img/2c526-3742.jpg" /></a>
                                    </div>
                                    <div class="cont">
                                        <ul>
                                            <li class="webtitle font18">
                                ...
                                <li class="item">
                                    <div class="imgbox">
                                        <a target="_blank" href="https://www.maigoo.com/webshop/316472.html">
                                            <img src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/img/f3c0f-3959.jpg" /></a>
                                    </div>
                                    <div class="cont">
                                        <ul>
                                            <li class="webtitle font18">
                                ...
                                <li class="item">
                                    <div class="imgbox">
                                        <a target="_blank" href="https://www.maigoo.com/webshop/339534.html">
                                            <img src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/img/a1c74-6123.jpg" /></a>
                                    </div>
                                    <div class="cont">
                                        <ul>
                                            <li class="webtitle font18">
...
<script type="text/javascript" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/js/brand_webshop_ff6029737f33b8628f23eefb68eef2a2.js"></script>
