...
<link href="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/css/ed99b-7817.css" type="text/css" rel="stylesheet" />
...
<div id="wrap">
    ...
    <header class="topfix hasnav">
        <div class="bg">
            <div class="head headdetail headblock ">
                <div class="headtop">
                    ...
                    <div class="title font16 fff dhidden ">
                        ...
                        <div class="mtitle dhidden">排行榜TOP10</div></div>
                    ...
                    <div id="slicemenu">
                        <div class="pagemenu">
                            ...
                            <div class="mpart position font14 color1">
                                ...
                                <i class="song">></i>
                                <a href="https://m.maigoo.com/brand10/">排行榜</a>
                                <i class="song">></i></div>
                            <div class="ttl font16 c000">相关行业：</div>
                            <div class="mpart col3word dn">
                                <a href="https://m.maigoo.com/maigoo/910ya_index.html" class="c666 dhidden">建材/家居</a>
                                <a href="https://m.maigoo.com/maigoo/202tl_index.html" class="c666 dhidden">科技/厨电</a>
                                <a href="https://m.maigoo.com/maigoo/1111gw_index.html" class="c666 dhidden">美妆/装扮</a>
                                <a href="https://m.maigoo.com/maigoo/1105kafei_index.html" class="c666 dhidden">美食/饮食</a>
                                <a href="https://m.maigoo.com/maigoo/1098zb_index.html" class="c666 dhidden">汽车/工具</a>
                                <a href="https://m.maigoo.com/maigoo/1103wyj_index.html" class="c666 dhidden">日用生活品</a>
                                <a href="https://m.maigoo.com/maigoo/1095hzp_index.html" class="c666 dhidden">健康/保健</a>
                                <a href="https://m.maigoo.com/brand10/list_5196.html" class="c666 dhidden">教育/母婴</a>
                                <a href="https://m.maigoo.com/maigoo/741hotel_index.html" class="c666 dhidden">运动/娱乐</a>
                                <a href="https://m.maigoo.com/brand10/list_5176.html" class="c666 dhidden">服务相关</a>
                                <a href="https://m.maigoo.com/maigoo/4867ppmq_index.html" class="c666 dhidden">品牌/名企</a>
                                <a href="https://m.maigoo.com/product/" class="c666 dhidden">网购/精选</a>
                                <a href="https://m.maigoo.com/zhaoshang/" class="c666 dhidden">招商加盟</a>
                                <a href="https://m.maigoo.com/news/" class="c666 dhidden">热点聚焦</a>
                                <a href="https://m.maigoo.com/maigoo/2455gjdq_index.html" class="c666 dhidden">城市/地区</a>
                                <a href="https://m.maigoo.com/brand10/" class="c666 dhidden">排行榜</a>
                                <a href="https://m.maigoo.com/zhishi/" class="c666 dhidden">知识百科</a>
                                <a href="https://m.maigoo.com/goomai/list_3665.html" class="c666 dhidden">人群/名人</a>
                                <div class="clear"></div>
                            </div>
                        </div>
            ...
            <div id="pagenav" class="categorynav col3">
                <div class="ulbox">
                    <ul>
                        <li class="font16 active cfff line2em">
                            <a href="https://m.maigoo.com/brand10/">
                                <span class="name dhidden">排行榜</span></a>
                        </li>
                        <li class="font16 cffff00 line2em">
                            <a href="https://m.maigoo.com/category/brand/?pid=">
                                <span class="name dhidden">品牌分类</span></a>
                        </li>
                        <li class="font16 cffff00 line2em">
                            <a href="https://m.maigoo.com/category/zhishi/?pid=">
                                <span class="name dhidden">知识分类</span></a>
                        </li>
                    </ul>
                </div>
                <div class="clear"></div>
    ...
    <div id="container">
        <div class="blockinfo brand10col1 " id="pos_brand10bang1">
            <div class="itembox">
                <ul>
                    <li class="item">
                        <a class="fff " href="https://m.maigoo.com/brand10/zhishibang/" style="background:url('<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/4f426-5956.jpg');">
                            <div class="left">
                                <div class="title font18">知识榜</div>
                                <div class="mintitle font10">知识课堂
                                    <i class="iconfont icon-gengduo4"></i></div>
                                <div class="img">
                                    <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/62734-4703.png" /></div>
                            </div>
                    ...
                    <li class="item">
                        <a class="fff " href="https://m.maigoo.com/brand10/pinpaibang/" style="background:url('<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/78ebd-9493.jpg');">
                            <div class="left">
                                <div class="title font18">品牌榜</div>
                                <div class="mintitle font10">十大品牌
                                    <i class="iconfont icon-gengduo4"></i></div>
                                <div class="img">
                                    <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/d36b1-1056.png" /></div>
                            </div>
                            <div class="right pinpaibang">
                                <div class="item2 dhidden">
                                    <img width="130" height="130" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/bb7a2-9465.jpg" />
                                    <span class="ttl font12">水管管道</span></div>
                                <div class="item2 dhidden">
                                    <img width="130" height="130" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/bb6f6-7477.jpg" />
                                    <span class="ttl font12">硅藻泥</span></div>
                                <div class="item2 dhidden">
                                    <img width="130" height="130" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/f1b2f-4723.jpg" />
                    ...
                    <li class="item">
                        <a class="fff " href="https://m.maigoo.com/brand10/wanggoubang/" style="background:url('<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/c8882-6393.jpg');">
                            <div class="left">
                                <div class="title font18">网购榜</div>
                                <div class="mintitle font10">网店排行
                                    <i class="iconfont icon-gengduo4"></i></div>
                                <div class="img">
                                    <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/2956e-4658.png" /></div>
                            </div>
                    ...
                    <li class="item">
                        <a class="fff " href="https://m.maigoo.com/brand10/zhaoshangbang/" style="background:url('<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/266bc-1056.jpg');">
                            <div class="left">
                                <div class="title font18">招商榜</div>
                                <div class="mintitle font10">招商加盟
                                    <i class="iconfont icon-gengduo4"></i></div>
                                <div class="img">
                                    <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/1c9ee-7635.png" /></div>
                            </div>
                            <div class="right zhaoshangbang">
                                <div class="item2 dhidden">
                                    <i>2</i>
                                    <img width="138" height="60" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/b4708-6864.jpg" />
                                    <span class="ttl font12">中广欧特斯</span></div>
                                <div class="item2 dhidden">
                                    <i>1</i>
                                    <img width="138" height="60" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/94c8f-5342.jpg" />
                                    <span class="ttl font12">肯帝亚</span></div>
                                <div class="item2 dhidden">
                                    <i>3</i>
                                    <img width="138" height="60" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/4968d-5015.jpg" />
                    ...
                    <li class="item">
                        <a class="fff " href="https://m.maigoo.com/brand10/quwenbang/" style="background:url('<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/104d9-1856.jpg');">
                            <div class="left">
                                <div class="title font18">趣闻榜</div>
                                <div class="mintitle font10">生活排行
                                    <i class="iconfont icon-gengduo4"></i></div>
                                <div class="img">
                                    <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/91f8f-7393.png" /></div>
                            </div>
                ...
                <ul>
                    <li class='item'>
                        <a class="fff s1" href="https://m.maigoo.com/brand10/renwubang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/651bd-3786.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s2" href="https://m.maigoo.com/brand10/zhuangxiubang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/f68a8-5249.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s3" href="https://m.maigoo.com/brand10/wangdianbang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/5f3c4-5008.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s4" href="https://m.maigoo.com/brand10/chanpinbang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/60ca1-1689.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s5" href="https://m.maigoo.com/brand10/yulebang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/0a950-7868.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s6" href="https://m.maigoo.com/brand10/qichebang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/b3322-9689.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s7" href="https://m.maigoo.com/brand10/lvyoubang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/92140-9904.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s8" href="https://m.maigoo.com/brand10/meishibang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/d34dd-1405.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s9" href="https://m.maigoo.com/brand10/fuwubang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/0b75f-3205.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s10" href="https://m.maigoo.com/brand10/zhongguobang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/0957f-4213.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s11" href="https://m.maigoo.com/brand10/shijiebang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/d5603-3554.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s12" href="https://m.maigoo.com/brand10/chengshibang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/cad72-5348.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s13" href="https://m.maigoo.com/brand10/jujiaobang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/d7dda-2549.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s14" href="https://m.maigoo.com/brand10/tixibang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/28a45-5877.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s15" href="https://m.maigoo.com/brand10/qiyebang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/7e6dc-8447.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s16" href="https://m.maigoo.com/brand10/hangyebang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/b9848-3053.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s17" href="https://m.maigoo.com/brand10/dianzanbang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/a09af-2121.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s18" href="https://m.maigoo.com/brand10/fenxiangbang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/42bda-4594.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s19" href="https://m.maigoo.com/brand10/biaoshengbang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/f2ca8-1375.png" /></div>
                        </a>
                    </li>
                    <li class='item'>
                        <a class="fff s20" href="https://m.maigoo.com/brand10/toupiaobang/">
                            ...
                            <div class="img">
                                <img width="100" height="100" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/img/e1c71-6798.png" /></div>
                        </a>
                    </li>
                </ul>
                <div class="clear"></div>
...
<footer>
    <div class="foot font12 fixed">
        <ul>
            <li>
                <a class="c666 line15em" href="/">
                    <i class="iconfont icon-shouye2"></i>首页</a>
            </li>
            <li>
                <a class="c666 line15em" href="/category/zhishi/">
                    <i class="iconfont icon-zhishilei"></i>知识分类</a>
            </li>
            <li>
                <a class="c666 line15em" href="/category/brand/">
                    <i class="iconfont icon-pinpaibang"></i>品牌分类</a>
            </li>
            <li class="active">
                <a class="c666 line15em" href="/brand10/">
                    <i class="iconfont icon-touzipaihangbang"></i>排行榜</a>
            </li>
            <li>
                <a class="c666 line15em" href="/user/">
                    <i class="iconfont icon-wode"></i>我的</a>
            </li>
        </ul>
        <div class="clear"></div>
    </div>
...
<script type="text/javascript" src="<?= Yii::getAlias('@tasseturl'); ?>/sguide/m/js/brand10_index_49ab1188e9bb6daa1bac4a3a6992e6eb.js"></script>
